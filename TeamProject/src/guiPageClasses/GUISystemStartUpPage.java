...
public class GUISystemStartUpPage {
	...
	**********************************************************************************************/
	...
	public GUISystemStartUpPage(Stage ps, Pane theRoot, Database db) {
		...
		theRootPane = theRoot;
            ...
            if (database.isDatabaseEmpty()) {
        		...
        		primaryStage.setTitle("CSE 360 HW1: First User Account Setup");	
	...
	private void setupNormalLogin() {
    	...
    	// Label theScene with the name of the system startup screen
		primaryStage.setTitle("CSE 360 HW1: User Login Page");	
	...
	**********************************************************************************************/
	...
	private void doSetupAdmin() {
		Boolean user_pass_valid = CheckUserPass.checkUserPass(adminUsername, adminPassword1);
		
		if (user_pass_valid && adminPassword1.compareTo(adminPassword2) == 0) {
 ...
 */   	
	...
	private void doCreateUser(String role, String iCode) {
		...
		if (user_pass_valid && text_Password1.getText().compareTo(text_Password2.getText()) == 0) {
